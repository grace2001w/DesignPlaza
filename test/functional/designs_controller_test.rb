...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { date: @design.date, description: @design.description, price: @design.price, size: @design.size, thumbnail: @design.thumbnail, title: @design.title }
    end
  ...
  test "should update design" do
    put :update, id: @design, design: { date: @design.date, description: @design.description, price: @design.price, size: @design.size, thumbnail: @design.thumbnail, title: @design.title }
    assert_redirected_to design_path(assigns(:design))
  end
